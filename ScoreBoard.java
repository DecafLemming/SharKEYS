 ...
 * UserInfo class.  
 * 
 * Adapted from scoreboard on Typing Greenfoot scenario by neil brown
 * 
 * @Author SassyPantz 
 * @Version 2014.12.14
 */
public class ScoreBoard extends Actor
{
    ...
    // The errorScore color:
    private static final Color ERROR_SCORE_COLOR = new Color( 0xB0, 0x40, 0x40 ); // orange-y
    ...
    */
    ...
    private void drawScores()
    {
        ...
        drawString( "Final Results", 235, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT );
    ...
    private void drawUserPanel(int left, int top, int right, int bottom, List users)
    {
        ...
        for (Object obj : users)
        {
            ...
            int x = left + 10;
            drawString( "Player Ranking:  " + "#" + Integer.toString( playerData.getRank() ), x, y+18, MAIN_COLOR, 14 );
            x += 130;
            
            drawString( "Keystrokes per second:  " + Integer.toString( playerData.getScore() ), x, y+18, MAIN_COLOR, 14 );
            x += 200;
            
            /**
             * *** TODO replace the 'placeholder' below of getScore with errorCount from Typing World subclass ***
             */
            drawString( "Errors Typed:  " + Integer.toString( playerData.getScore() ), x, y+18, ERROR_SCORE_COLOR, 14 );//+ Integer.toString( Typing.errorCount ), x, y+18, MAIN_COLOR, 14 );
            //getWorld.getErrorCount ), x, y+18, ERROR_SCORE_COLOR, 14 );//+ Integer.toString( Typing.errorCount ), x, y+18, MAIN_COLOR, 14 );
            x += 120;
